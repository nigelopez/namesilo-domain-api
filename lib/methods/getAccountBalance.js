...
// https://www.namesilo.com/api_reference.php#getAccountBalance
module.exports.getAccountBalance = function (config, axios, options = {}) {
    return new Promise(function(resolve, reject) {                
        // validations
        if (config.apiKey == null) return reject('API Key can not be null.')
        
        axios.post('getAccountBalance', querystring.stringify({ ...options}))
