...
NameSilo.prototype.domainInfo = function (domain) {
    return require('./methods/domainInfo').domainInfo(this.config, this.axios, domain);
};
...
NameSilo.prototype.getAccountBalance = function(domain,nameservers) {    
    return require('./methods/getAccountBalance').getAccountBalance(this.config, this.axios)
};
